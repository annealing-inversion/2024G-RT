...
impl bvh_node {
    // pub fn new(left: Rc<dyn Hittable>, right: Rc<dyn Hittable>, time0: f64, time1: f64) -> Self {
    ...
    fn new_with_span(mut objects: Vec<Rc<dyn Hittable>>, start: usize, end: usize) -> Self {
        let mut tmp = Self {left: Rc::new(HittableList::new()), right: Rc::new(HittableList::new()), bbox: aabb::empty};
        // tmp.bbox = aabb::empty;
        ...
        let comparator = match axis {
            0 => |a: &Rc<dyn Hittable>, b: &Rc<dyn Hittable>| Self::box_x_compare(a.clone(), b.clone()),
            1 => |a: &Rc<dyn Hittable>, b: &Rc<dyn Hittable>| Self::box_y_compare(a.clone(), b.clone()),
            2 => |a: &Rc<dyn Hittable>, b: &Rc<dyn Hittable>| Self::box_z_compare(a.clone(), b.clone()),
        ...
        if object_span == 1 {
            ...
            tmp.left = Rc::new(bvh_node::new_with_span(objects.clone(), start, mid));
            tmp.right = Rc::new(bvh_node::new_with_span(objects.clone(), mid, end));
        }
